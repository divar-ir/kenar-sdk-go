...
// PaymentWalletTransactionStatus وضعیت‌های مختلف تراکنش کیف پول: UNKNOWN (پیش‌فرض - نباید استفاده شود)، CREATED (در انتظار پرداخت)، EXPIRED (منقضی شده)، PAID (پرداخت شده، در انتظار تایید نهایی)، COMMITTED (نهایی شده).
