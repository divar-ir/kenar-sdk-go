...
**PriceCostPerExtraPerson** | Pointer to **string** | Cost per extra person per night in Rial | [optional] 
**PriceRegularDays** | Pointer to **string** | Price of the residence for regular days (Saturday to Tuesday) in Rial | [optional] 
**PriceSpecialDays** | Pointer to **string** | Price of the residence for special days (holidays and occasions) in Rial | [optional] 
**PriceWeekends** | Pointer to **string** | Price of the residence for weekends (Wednesday to Friday) in Rial | [optional] 
