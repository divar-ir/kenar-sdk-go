...
type ApiPostSubmitEmergencyResidencePostRequest struct {
	ctx context.Context
	ApiService *PostAPIService
	postSubmitEmergencyResidencePostRequest *PostSubmitEmergencyResidencePostRequest
}

func (r ApiPostSubmitEmergencyResidencePostRequest) PostSubmitEmergencyResidencePostRequest(postSubmitEmergencyResidencePostRequest PostSubmitEmergencyResidencePostRequest) ApiPostSubmitEmergencyResidencePostRequest {
	r.postSubmitEmergencyResidencePostRequest = &postSubmitEmergencyResidencePostRequest
	return r
}

func (r ApiPostSubmitEmergencyResidencePostRequest) Execute() (*PostSubmitEmergencyResidencePostResponse, *http.Response, error) {
	return r.ApiService.PostSubmitEmergencyResidencePostExecute(r)
}

/*
PostSubmitEmergencyResidencePost Submit an emergency residence post

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiPostSubmitEmergencyResidencePostRequest
*/
func (a *PostAPIService) PostSubmitEmergencyResidencePost(ctx context.Context) ApiPostSubmitEmergencyResidencePostRequest {
	return ApiPostSubmitEmergencyResidencePostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return PostSubmitEmergencyResidencePostResponse
func (a *PostAPIService) PostSubmitEmergencyResidencePostExecute(r ApiPostSubmitEmergencyResidencePostRequest) (*PostSubmitEmergencyResidencePostResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *PostSubmitEmergencyResidencePostResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PostAPIService.PostSubmitEmergencyResidencePost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/experimental/open-platform/posts/emergency-residence"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.postSubmitEmergencyResidencePostRequest == nil {
		return localVarReturnValue, nil, reportError("postSubmitEmergencyResidencePostRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.postSubmitEmergencyResidencePostRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["APIKey"]; ok {
