...
type AddonsAddonSemantic struct {
	PaymentMethod *AddonSemanticPaymentMethod `json:"payment_method,omitempty"`
...
func (o *AddonsAddonSemantic) GetPaymentMethod() AddonSemanticPaymentMethod {
	if o == nil || IsNil(o.PaymentMethod) {
		var ret AddonSemanticPaymentMethod
		return ret
	}
...
// SetPaymentMethod gets a reference to the given AddonSemanticPaymentMethod and assigns it to the PaymentMethod field.
