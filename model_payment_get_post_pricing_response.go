...
type PaymentGetPostPricingResponse struct {
	Renew *GetPostPricingResponseRenew `json:"renew,omitempty"`
...
func (o *PaymentGetPostPricingResponse) GetRenew() GetPostPricingResponseRenew {
	if o == nil || IsNil(o.Renew) {
		var ret GetPostPricingResponseRenew
		return ret
	}
	return *o.Renew
}
...
// SetRenew gets a reference to the given GetPostPricingResponseRenew and assigns it to the Renew field.
