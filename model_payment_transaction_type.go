...
const (
	...
	PAYMENTTRANSACTIONTYPE_TRANSACTION_TYPE_SUBMIT PaymentTransactionType = "TRANSACTION_TYPE_SUBMIT"
	PAYMENTTRANSACTIONTYPE_TRANSACTION_TYPE_RENEW PaymentTransactionType = "TRANSACTION_TYPE_RENEW"
)
